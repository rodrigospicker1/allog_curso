...
public class CustomerController : ControllerBase
{
    ...
    public ActionResult<IEnumerable<CustomerDTO>> GetCustomers()
    {
        ...
        var customersToReturn = Data.getData().customers
    ...
    public ActionResult<List<CustomerDTO>> CreateCustomers(CustomerForCreationDto customerForCreationDto)
    {
        ...
        Data.getData().customers.Add(customerEntity);
    ...
    public ActionResult UpdateCustomer(int id, CustomerForUpdateDto customerForUpdateDto)
    {
        ...
        var customerFromDatabase = Data.getData().customers
    ...
    public ActionResult DeleteCustomer(int id)
    {
        ...
        Data.getData().customers.Remove(customerFromDatabase);
