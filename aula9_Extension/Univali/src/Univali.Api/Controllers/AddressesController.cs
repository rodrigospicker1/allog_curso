...
public class AddressesController : MainController
{
    ...
    public ActionResult<IEnumerable<AddressDto>> GetAddresses(int customerId)
    {
        ...
        var addressFromDatabase = _context.Addresses.OrderBy(c => c.Id).ToList();
        var addressToReturn = _mapper
                    .Map<IEnumerable<AddressDto>>(addressFromDatabase);
    ...
    public ActionResult<AddressDto> GetAddress(int customerId, int addressId)
    {
        ...
        // return Ok(addressToReturn);
        var addressFromDatabase = _context
    ...
    public ActionResult DeleteAddress(int customerId, int addressId)
    {
        ...
        var addressromDatabase = _context.Addresses
            .FirstOrDefault(address => address.Id == addressId);

        if (addressromDatabase == null) return NotFound();
        
        _context.Addresses.Remove(addressromDatabase);
        _context.SaveChanges();
